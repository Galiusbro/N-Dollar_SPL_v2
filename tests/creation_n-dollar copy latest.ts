...
//         .createUserToken(name, symbol, uri, totalSupply) // Removed nDollarAmountForRent
//         .accounts({
...
//           authority: wallet.publicKey,
//           rentPayer: wallet.publicKey, // Added rentPayer

//           // Удалены аккаунты, связанные с пулом ликвидности и solMint,
//           // так как они больше не используются в Rust-программе create_user_token
...
//           tokenMetadataProgram: METADATA_PROGRAM_ID,
//           // ID программ
//           // liquidityPoolProgram: liquidityPoolProgram.programId, // Removed
//         })
//         .preInstructions([
...
//       tokenCreatorProgram.programId
//     );
//     tokenInfoPda = tokenInfoPdaLocal; // Присваиваем глобальной переменной
